...
const CustomizeLegend = ({ active, payload, LegendValues, data, setData }) => {
    ...
    if (payload?.length && keys?.length > 0) {
        return (
            <>
                <div id='legend' style={{ backgroundColor: "white", color: "black", display: "flex", alignItems: "center", boxSizing: "border-box", justifyContent: "center", margin: "0", padding: "0" }}>
        ...
        return (
            <>
                ...
                <div style={{ backgroundColor: "white", color: "black", display: "flex", alignItems: "center", boxSizing: "border-box", justifyContent: "center", margin: "0", padding: "0" }}>
                    {payload?.map((ele, index) => {
                        return (
